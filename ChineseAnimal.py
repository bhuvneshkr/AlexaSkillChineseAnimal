...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        handler_input.response_builder.speak("Welcome to the chinese animal skill").set_should_end_session(False)
...
class ChineseAnimalIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speech_text = "Your chinese animal is " + data['Item']['Animal']['S']
